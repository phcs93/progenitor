document.addEventListener("DOMContentLoaded", () => {
    ...
    const terrain = new Sphere(10, gl, terrainVertexShaderSource, fragmentShaderSource);
    const ocean = new Sphere(10, gl, oceanVertexShaderSource, fragmentShaderSource, true);
    const clouds = new Sphere(10, gl, cloudsVertexShaderSource, fragmentShaderSource, true);
